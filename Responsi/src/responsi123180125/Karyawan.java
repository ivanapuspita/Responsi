    ...
    JButton btnHome = new JButton("Home");
      ...
      JButton btnData = new JButton("Data");
       JButton btnPetunjuk = new JButton("Petunjuk");
        ...
        Object namaKolom[] = {"ID Karyawan","Nama","Posisi","Alamat","Telp","Gaji"};
        ...
        if (this.getBanyakData() != 0) { 
                    String datagaji[][] = this.readKaryawan(); 
...
String[][] readKaryawan() {
                try{
                    ...
                    ResultSet resultSet = statement.executeQuery(query);
                    while(resultSet.next()){
                        data[jmlData][0] = resultSet.getString("idkar");
                        data[jmlData][1] = resultSet.getString("namakar");
                        data[jmlData][2] = resultSet.getString("posisikar");
                        data[jmlData][3] = resultSet.getString("alamatkar");
                        data[jmlData][4] = resultSet.getString("telpkar");
                        data[jmlData][5] = resultSet.getString("totalkar");
...
void deleteKaryawan(String idkar) {
  try{
    String query = "DELETE FROM `karyawan` WHERE `idkar` = '"+idkar+"'";
                    statement = koneksi.createStatement();
